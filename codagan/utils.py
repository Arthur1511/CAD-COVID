...
def get_data_loader_folder(input_folder, mode, dataset_number, batch_size, shuffle, trim, num_workers=4, sample=-1, return_path=False, random_transform=False, channels=1):
    ...
    # dataset = ImageFolder(input_folder, sample=sample, fold=fold, dataset_letter=dataset_letter,
...
def norm(arr, multichannel=False):
    ...
    if not multichannel:
        ...
        tmp = np.zeros((arr.shape[1], arr.shape[2],
